...
model = Sequential()
model.add(Flatten(input_shape=(1,1,70,2)))
...
dqt = DeepQTrading(
    ...
    begin=datetime.datetime(1997,9,1,0,0,0,0), # CHANGED 2001,1,1,0,0,0,0
    end=datetime.datetime(2016,3,8,0,0,0,0), # CHANGED 2019,2,28,0,0,0,0
